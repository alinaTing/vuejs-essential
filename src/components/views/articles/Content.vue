            ...
            <div class="votes-container panel panel-default padding-md">
                <div class="panel-body vote-box text-center">
                    ...
                    <div class="voted-users">
                        ...
                        <span v-for="likeUser in likeUsers" v-bind:key="likeUser" >
            ...
            <Modal :show.sync="showQrcode" class="text-center">
                ...
                <div>
                    ...
                    <div class="payment-qrcode inline-block">
                        ...
                        <!--
                        <p><img src="https://cdn.learnku.com/uploads/images/201803/25/2/g3CFVs0h7B.jpeg?imageView2/2/w/1024/h/0" width="160">
                        -->
